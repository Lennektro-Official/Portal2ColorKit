...
WINDOWS_PATCH: Final = Patch(
    "UtilPortalColor",
    "0F 84 82 00 00 00 8B 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 84 C0 75 73",
    "90 90 90 90 90 90 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 90 90 90 90"
)

LINUX_PATCH: Final = Patch(
    "UtilPortalColor",
    "75 6F A1 ?? ?? ?? ?? 8D 14 5B 8D 44 90 6C F3 0F 10 48 08 F3 0F 10 05 ?? ?? ?? ?? F3 0F 59 C8 F3 0F 2C D1 F3 0F 10 48 04 F3 0F 59 C8 F3 0F 59 00 C6 46 03 00 88 56 02 F3 0F 2C C9 F3 0F 2C C0 88 4E 01 88 06 83 C4 04 89 F0 5B 5E C2 04 00 8D 76 00 C7 06 FF FF FF FF 83 C4 04 89 F0 5B 5E C2 04 00 C7 06 F2 CA A7 FF 83 C4 04 89 F0 5B 5E C2 04 00 83 EC 0C FF 35 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 C4 10 84 C0 0F 85 ?? ?? ?? ?? 8B 44 24 18 83 E8 02 83 F8 01 76",
